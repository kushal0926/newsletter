...
export default function Error() {
  ...
  return (
    ...
    >
      <FiAlertCircle className="text-cream text-9xl mb-6 animate-pulse" />
      ...
      <button
        onClick={goHome}
        className="mt-8 px-6 py-3 bg-cream hover:bg-gray-400 text-ink font-semibold rounded-lg shadow-lg transition-all duration-300"
      >
        Go Back Home
      </button>
    </div>
